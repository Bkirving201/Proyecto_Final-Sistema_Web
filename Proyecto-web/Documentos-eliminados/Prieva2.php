...
<body>
	...
	<div id="general">
		...
		<div id="navegacion">
			...
			<a href="">
				<button id="boton">Registro</button>
			</a>
				<button id="boton">Habitaciones</button>
                <button id="boton">Datos registrados</button>
			</div>
		</div>
		
		<div id="cuerpo">
					<div id="cuerpo-registro">
						<div id="cuerpo-registro2">
							<div id="alineacion-cuerpo-registro">
								...
								<input type="Nombre" name="Correio" id="espaciado">
									<button id="habiaciones-titulo-cuerpo-registro">V Habitaciones V</button>

                        ...
                        <div id="efectivo" style="display: none" class="row">
                           ...
                           <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input name="fechaefectivo" type="date" class="form-control"  value="<?php echo $fcha;?>" >                            </div>
                        ...
                        <! -- Aqui se llevaran a cabo las consultas necesarias para mostrar datos de forma responsiva desde la base de datos -->
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="MenuTipo" class="form-control" name="tipohabitacion" >
                                    ...
                                    <option selected>Seleccionar.....</option>
                                    <option value="Habitacion Chica" name="Habitacion Chica">Habitacion Chica</option>
                                    <option value="Habitacion Mediana" name="Habitacion Mediana">Habitacion Mediana</option>
                                    <option value="Habitacion Grande" name="Habitacion Grande">Habitacion Grande</option>
                                    <option value="Habitacion Suite" name="Habitacion Suite">Habitacion Suite</option>

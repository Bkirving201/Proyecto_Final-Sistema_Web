                ...
                <nav class="alineacion" aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>">
                            ...
                            <a class="page-link" href="registro.php?pagina=<?php echo $_GET['pagina'] - 1 ?>" aria-label="Previous">
                        ...
                        <li class="page-item <?php echo $_GET['pagina'] >= $paginas ? 'disabled' : '' ?> ">
                            ...
                            <a class="page-link" href="registro.php?pagina=<?php echo $_GET['pagina'] + 1 ?>" aria-label="Next">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="buttondelete" data-bs-toggle="modal" data-bs-target="#deleteReserva<?php echo $MostrarReservas['idReserva']; ?>">
